...
for i in xrange(npts):
    yint[i] = Ngl.ftcurvpi(0.0, xo[i], period, xi, yi)
...
Ngl.text_ndc(wks, "Demo for ftcurvp, ftcurvpi", 0.5, 0.95, txres)

xperiod1 = [0.41, 0.2633, 0.2633, 0.2633, 0.2833, 0.2633, 0.2833, 0.2633, 0.2633]
xperiod2 = [0.5166, 0.6633, 0.6633, 0.6633, 0.6433, 0.6633, 0.6433, 0.6633, 0.6633]
yperiod = [0.503, 0.503, 0.523, 0.503, 0.513, 0.503, 0.493, 0.503, 0.4830]
