...
#
x = [10.0, 20.00, 30.0, 40.0, 50.000, 60.00, 70.0, 80.00, 90.000]
y = [0.0, 0.71, 1.0, 0.7, 0.002, -0.71, -1.0, -0.71, -0.003]
...
y2 = Numeric.array(
    [
        [0.0, 0.7, 1.0, 0.7, 0.0, -0.7, -1.0, -0.7, 0.0],
        [2.0, 2.7, 3.0, 2.7, 2.0, 1.3, 1.0, 1.3, 2.0],
        [4.0, 4.7, 5.0, 4.7, 4.0, 3.3, 3.0, 3.3, 4.0],
    ],
    Numeric.Float0,
)
...
resources.xyLineThicknesses = [1.0, 2.0, 5.0]  # Define line thicknesses
# (1.0 is the default).
