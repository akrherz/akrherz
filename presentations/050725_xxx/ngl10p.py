...
def wigley(time):
    ...
    Numeric.putmask(
        y,
        Numeric.logical_and(
            Numeric.greater(time, 1973.0), Numeric.less_equal(time, 1990.0)
        ),
        ((time - 1973.0) / (1990.0 - 1973.0)) * (75.0 - 68.0) + 68.0,
    )
    return y
...
resources.caXMissingV = -999.0
resources.caYMissingV = -999.0
...
xpos = [1885.0, 1940.0, 1860.0]  # Define X/Y locations for text.
ypos = [30.0, 18.0, 70.0]
