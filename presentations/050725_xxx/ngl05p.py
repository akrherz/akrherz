...
resources.mpCenterLonF = 180.0  # Rotate the projection.
...
if hasattr(pf, "_FillValue"):
    pfa = 0.01 * (
        pfa * Numeric.not_equal(pfa, pf._FillValue)
...
txres.txFontColor = 4
Ngl.text_ndc(wks, ":F25:Pressure (mb)", 0.41, 0.185, txres)
...
resources.cnLevels = Numeric.arange(985.0, 1046.0, 5.0)
