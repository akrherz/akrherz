...
<div class="panel-heading">Twitter Followers as of 21 March 2023:</div>
  <div class="panel-body">

  <span><strong>@akrherz:</strong> 4,614</span>
<div class="progress">
  ...
  <span><strong>@mjanders1:</strong> 4,463</span>
<div class="progress">
    <div class="progress-bar progress-bar-green" role="progressbar" aria-valuenow="97" aria-valuemin="0" aria-valuemax="100" style="width: 97%;">
    </div>
</div>

<span><strong>@alisonrISU:</strong> 4,393</span>
<div class="progress">
...
<span><strong>@erinwhodgson:</strong> 3,149</span>
<div class="progress">
    <div class="progress-bar progress-bar-green" role="progressbar" aria-valuenow="68" aria-valuemin="0" aria-valuemax="100" style="width: 68%;">
    </div>
</div>

<span><strong>@nciacrops:</strong> 2,445</span>
<div class="progress">
    <div class="progress-bar progress-bar-green" role="progressbar" aria-valuenow="53" aria-valuemin="0" aria-valuemax="100" style="width: 53%;">
    </div>
</div>

<span><strong>@jjmichel_crops:</strong> 293</span>
<div class="progress">
    <div class="progress-bar progress-bar-red" role="progressbar" aria-valuenow="6" aria-valuemin="0" aria-valuemax="100" style="width: 6%;">
    </div>
</div>
