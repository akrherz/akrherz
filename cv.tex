...
\normalsize \sf
\begin{itemize}
\item Iowa Environmental Mesonet (2)\\
...
\end{itemize}
\vspace*{0.25in}
\Large \bf Past Research Projects (Team Size)
\normalsize \sf
\begin{itemize}
\item Iowa Department of Transportation (2)\\
...
models.
\item Mississippi Department of Transporation (5)\\
...
Mississippi Roads.
\item Multi-RCM Ensemble Downscaling (3)\\
...
\item North American Regional Climate Change Assessment Program (10s)\\
...
\item Pacific Climate Change Science Program (4)\\
Proctored the simulation of climate models on High Performance Computing.
 Analyzed the output and prepared model output summary files as per 
community standards.  Assisted in the development and debugging of model
codes for this effort.
